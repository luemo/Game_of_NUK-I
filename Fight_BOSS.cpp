...
int Fight_BOSS(SAMPLE *Music)
{
	...
	FAC.character1.HPMAX = 99;
	FAC.character1.HP = 99;
	FAC.character1.MPMAX = 87;
	FAC.character1.MP = 87;
	FAC.character2 = Character02;
	FAC.character2.HPMAX = 82;
	FAC.character2.HP = 82;
	FAC.character2.MPMAX = 76;
	FAC.character2.MP = 76;
	FAC.character3 = Character03;
	FAC.character3.HPMAX = 80;
	FAC.character3.HP = 80;
	FAC.character3.MPMAX = 73;
	FAC.character3.MP = 73;
	FAC.character4 = Character04;
	FAC.character4.HPMAX = 89;
	FAC.character4.HP = 89;
	FAC.character4.MPMAX = 81;
	FAC.character4.MP = 81;

/****************************************************************************************/

	struct Monster Boss01;
	BITMAP *BossBIT01 = load_bitmap ("image\\Monster\\principlebattle.bmp",NULL);//怪物圖
