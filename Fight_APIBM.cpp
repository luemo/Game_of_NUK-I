...
int Fight_APIBM(SAMPLE *Music)
{
	...
	FAC.character1.HPMAX = 70;
	FAC.character1.HP = 70;
	FAC.character1.MPMAX = 54;
	FAC.character1.MP = 54;
	FAC.character2 = Character02;
	FAC.character2.HPMAX = 72;
	FAC.character2.HP = 72;
	FAC.character2.MPMAX = 60;
	FAC.character2.MP = 60;
	FAC.character3 = Character03;
	FAC.character3.HPMAX = 66;
	FAC.character3.HP = 66;
	FAC.character3.MPMAX = 48;
	FAC.character3.MP = 48;
	FAC.character4 = Character04;
	FAC.character4.HPMAX = 74;
	FAC.character4.HP = 74;
	FAC.character4.MPMAX = 63;
	FAC.character4.MP = 63;

/****************************************************************************************/

	struct Monster Boss01;
	BITMAP *BossBIT01 = load_bitmap ("image\\Monster\\APIBMbattle.bmp",NULL);//怪物圖
